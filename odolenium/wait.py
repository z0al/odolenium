#
# Copy from https://github.com/meta-it/odooselenium/blob/develop/odooselenium/wait.py
#
# Credit
# -------
# benoitbryon at https://github.com/meta-it/odooselenium/blob/develop/odooselenium/wait.py
#
import time
